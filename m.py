...
def  path(s):
    print("state:0")
    print(m,"M",n,"C","left side of river")
    print(0,"M",0,"C","right side of river")
    print("Boat:left")
...
m = int(input("Enter no of missionaries (m): "))
n = int(input("Enter no of cannibals (n): "))
solution = bfs(m, n)
if solution:
